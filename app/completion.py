...
system_prompt = '''As a tech reviewer, and Drupal 10 specialist, please provide, an in-depth review of the
...
explanations. You can use code snippets to exemplify whatever is needed, but keep simple. 
Please note that unnecessary explanations or summaries should be avoided
